...
class MCMCTools:
        ...
        if 'binarity' not in kwargs or kwargs['binarity']:
            if type is not None:
                ...
                try:
                    ...
                    raise ValueError('binarity must be True or False if type not defined for data')
            if self.binarity:
    ...
    def extract_subarray(self, data, center_x, center_y, size=3, flat_and_skip_center=True):
        ...
        - flat_and_skip_center: Boolean, whether to flatten the subarray and skip the center value.
    ...
    def run(self, data, psf, x_guess=0, y_guess=0, r=0, nsteps=5000, ndim=3, nwalkers=32,
        ...
        def log_likelihood(params, star_image, psf, centers, binarity, rotate, r, show_plots=False, vmin=None, vmax=None, vminres=None,
            ...
            Args:
                ...
                vmaxres (float): Maximum value for residual plotting.
                path2fitsfile (str): Path to the fits file.
