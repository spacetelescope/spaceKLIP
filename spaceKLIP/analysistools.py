...
class AnalysisTools():
    ...
    def raw_contrast(self,
        ...
        overwrite_starcen : tuple of two float, optional
            Overwrite the PSF center with the (STARCENX, STARCENY) values
            provided here (in 1-indexed coordinates).
            This is required for Coron3 data! The default is None.
        subdir : str, optional
            Name of the directory where the data products shall be saved.
            The default is 'rawcon'.
        output_filetype : str
            File type to save the raw contrast information to.
            Options are 'ecsv' or 'npy'.
    ...
    def calibrate_contrast(self,
        ...
        injection_flux_sigma : float, optional
            The peak flux of all injected companions in units of sigma,
            relative to the 1-sigma contrast at the injected separation.
        multi_injection_spacing : int, None, optional
            Spacing between companions injected in a single image.
            If companions are too close then it can pollute the recovered flux.
            Set to 'None' to inject only one companion at a time (lambda/D).
        use_saved : bool, optional
            Toggle to use existing saved injected and recovered fluxes instead
            of repeating the process.
        thrput_fit_method : str, optional
            Method to use when fitting/interpolating the measure KLIP
            throughputs across all of the injection positions.
            'median' for a median of PAs at with the same separation.
            'log_grow' for a logistic growth function.
            ...
            for j in range(nfitsfiles):
                ...
                for k in range(len(rawseps)):
                    ...
                    if thrput_fit_method == 'median':
                        ...
                        raise ValueError("Invalid thrput_fit_method: {}, options are 'median' or 'log_grow'".format(thrput_fit_method))
